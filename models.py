...
class DeepColorSimple(nn.Module):
    def __init__(self):
        ...
        self.conv6 = nn.Conv2d(in_channels=64, out_channels=32, kernel_size=(3, 3), stride=1, padding=1)

        self.fc1 = nn.Linear(32*2*2, 256)
        self.fc2 = nn.Linear(256, 256)
        self.fc3 = nn.Linear(256, 1024)

        self.deconv1 = nn.ConvTranspose2d(in_channels=1, out_channels=3, kernel_size=(5, 5))
